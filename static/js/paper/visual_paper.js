...
var svg_edges = svg.selectAll("line")
    ...
    .style("stroke-width", d => Math.sqrt(d.weight/100));//线条的宽度
...
var svg_node = svg.selectAll("circle")
    .on("click", function (d, i) {
        ...
        document.getElementById("papername").innerHTML = nodes[i].title;
        document.getElementById("papername").href = nodes[i].link;
...
function getRoute() {  //最短路径展示
    ...
    if (s >= 0 && e >= 0) {
        ...
        for(var i = 0; i < len; i++){
            pathname[i] = "《"+nodes[path[ans][i]].title+"》";
        }
